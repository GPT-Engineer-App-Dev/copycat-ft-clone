...
const Stories = () => {
  return (
    <Container centerContent maxW="container.md" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center" bg="#ffcc00">
      <VStack spacing={4}>
        <Heading as="h1" size="2xl">Stories</Heading>
        <Text fontSize="lg">Read the latest stories from the Financial Times.</Text>
        <Box boxSize="sm" bg="gray.200" display="flex" justifyContent="center" alignItems="center">
          <Text fontSize="xl">Story 1: Market Trends</Text>
        </Box>
        <Box boxSize="sm" bg="gray.200" display="flex" justifyContent="center" alignItems="center">
          <Text fontSize="xl">Story 2: Economic Insights</Text>
        </Box>
        <Box boxSize="sm" bg="gray.200" display="flex" justifyContent="center" alignItems="center">
          <Text fontSize="xl">Story 3: Financial Analysis</Text>
        </Box>
      </VStack>
    </Container>
  );
